...
public class ProductManagementUI implements IGenericUI {
    ...
    private void updateProductInPresentation(Scanner sc) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    System.out.println(BLUE_BRIGHT+"Tên cũ: "+ product.getName() + RESET);
                    product.setName(validateName(sc, "😋 Nhập tên mới cho sản phẩm này: ", productServiceImpl));
                    break;
                case 2:
                    System.out.println(BLUE_BRIGHT+"Tên nhãn hàng cũ: "+ product.getBrand() + RESET);
                    product.setBrand(validateInputNotEmpty(sc, "😊 Nhập tên nhãn hàng mới cho sản phẩm này: "));
                    break;
                case 3:
                    System.out.println(BLUE_BRIGHT+"Gía cũ: "+ product.getPrice() + RESET);
                    product.setPrice(validateDoubleInput(sc, "🫡 Nhập giá mới cho sản phẩm này: "));
                    break;
                case 4:
                    System.out.println(BLUE_BRIGHT+"Số lượng tồn kho cũ: "+ product.getStock() + RESET);
                ...
                case 5:
                    ...
                    return;
                case 6:
                    System.out.println(GREEN_BOLD_BRIGHT+ "✅ Đã hủy các thao tác thay đổi sản phẩm"+ RESET);
                    return;
                default:
